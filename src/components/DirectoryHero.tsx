...
export default function DirectoryHero({ image, children }: DirectoryHeroProps) {
  return (
    <section aria-labelledby="cause-heading">
      <div className="relative bg-gray-800 h-[600px] min-h-fit">
        ...
        />
        <div className="relative mx-auto my-auto flex flex-col items-center text-center px-6 py-32 sm:px-12  lg:px-16">
          {children}
        </div>
      </div>
    </section>
