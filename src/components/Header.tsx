    ...
    <header className="fixed top-0 right-0 left-0 z-10">
      ...
      <div className="w-full h-20 px-12 py-4 bg-white shadow justify-start items-center gap-12 flex flex-row">
        ...
        {/* <div className="justify-start items-center gap-8 flex">
          <div className="h-8 bg-white rounded justify-start items-center gap-6 flex">
            <div className="py-1 justify-start items-center gap-1 flex">
              <div className="text-teal-800 text-xs font-bold uppercase leading-tight tracking-wide">
                Services
              </div>
              <div className="w-6 h-6 p-0.5 bg-white rounded justify-center items-center flex">
                <svg
                  width="24"
                  height="25"
                  viewBox="0 0 24 25"
        ...
        <div className="w-full h-12 gap-4 flex justify-end">
          {/* <div className="w-48 p-4 bg-white rounded-full border border-stone-300 justify-end items-center gap-2 flex">
            <div className="text-zinc-600 text-xs font-medium  leading-tight tracking-tight">
              Search for anything...
            </div>
          </div> */}
          <button
          ...
          <div className="p-4 bg-cta-green rounded-full justify-end items-center gap-2 flex hover:bg-primary-green">
            <div className="text-center text-white text-s font-bold leading-normal whitespace-nowrap">
              Find a Provider
            </div>
          </div>
        </div>
